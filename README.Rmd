...
[![Codecov test coverage](https://codecov.io/gh/VoronDM/SNPassoc/graph/badge.svg)](https://app.codecov.io/gh/VoronDM/SNPassoc)
<!-- badges: end -->
...
You can install the development version of SNPassoc from [GitHub](https://github.com/) with:
